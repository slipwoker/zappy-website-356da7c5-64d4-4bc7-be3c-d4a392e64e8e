    ...
    if ('IntersectionObserver' in window) {
      ...
      animatableElements.forEach(function (el, index) {
        if (!el.hasAttribute('data-delay')) {
          ...
          const stagger = siblingIndex > 0 ? siblingIndex * 0.1 : 0;
          if (stagger > 0) {
            el.setAttribute('data-delay', stagger.toFixed(1));
          }
        }
        observer.observe(el);
      });
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Brawl Kruk משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '356da7c5-64d4-4bc7-be3c-d4a392e64e8e',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '356da7c5-64d4-4bc7-be3c-d4a392e64e8e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '356da7c5-64d4-4bc7-be3c-d4a392e64e8e';
